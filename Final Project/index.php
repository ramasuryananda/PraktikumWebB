...
<head>
	<meta charset="utf-8">
	<title>Home Perpustakaan Udayana</title>
...
<body>
    ...
    <div id="section1">
        ...
        <h1>Selamat Datang <b style="color: #DC8239;"><?php echo $_SESSION['username'];?></b> Di Perpustakaan Udayana</h1>
    </div>
    ...
    <div id="section3">
        <h2>Perpustakaan Udayana</h2>
        <p> Perpustakaan Udayana merupakan perpustakaan kampus lengkap yang menyediakan buku-buku dari berbagai jenis atau berbagai genre. Pembaca dari berbagai kalangan dapat dengan nyaman membaca di perpustakaan ini. Pembaca dapat membaca langsung buku yang diinginkan di perpustakaan atapun meminjamnya untuk dibaca dirumah. Pembaca dapat meminjaman buku paling lama 2 minggu. Apabila buku tidak dikembalikan sesuai tenggat waktu, maka pembaca akan dikenakan sanksi berupa pembayaran sebesar Rp 100.000 per buku. Itulah sekilas tentang Perpustakaan Udayana. Kami akan selalu menyambut kalian dengan ramah.</p>
    </div>
    <hr>
    <div id="section4">
